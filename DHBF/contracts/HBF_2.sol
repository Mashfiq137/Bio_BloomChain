...
contract HBF {
    uint256 private constant BITSTREAM_SIZE = 140554;
    uint256 private constant INDEXES_PER_PERSON = 4;
    uint256 private constant LEVELS = 165;
    uint256 private constant VALUES_PER_UINT256 = 16; // 256 bits / 16 bits per uint16
